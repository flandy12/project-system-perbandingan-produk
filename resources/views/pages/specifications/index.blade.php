                        ...
                        @forelse ($specifications as $spec)
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-center space-x-2">
                                    ...
                                    <form action="{{ route('specifications.destroy', $spec) }}"
                                        method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            onclick="return confirm('Hapus specification ini?')"
                                            class="text-red-600">
                                            Delete
                                        </button>
                                    </form>
        ...
        <div x-show="open" x-cloak
            ...
            <div @click.away="closeModal()"
                ...
                <h3 class="text-lg font-semibold mb-4"
                    x-text="isEdit ? 'Edit Specification' : 'Tambah Specification'">
                </h3>
                ...
                <form
                    ...
                    <input type="text"
                        ...
                        placeholder="Nama Specification"
                        required>

                    <select name="specification_group_id"
